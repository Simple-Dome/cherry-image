...
function resolveModelIcon(model: string) {
    ...
    if (name.includes("claude") || name.includes("anthropic")) return `${iconsBaseUrl}claude.svg`;
    if (name.includes("gemini") || name.includes("google")) return `${iconsBaseUrl}gemini.svg`;
    if (name.includes("gpt") || name.includes("openai")) return `${iconsBaseUrl}openai.svg`;
    if (name.includes("grok") || name.includes("grok")) return `${iconsBaseUrl}grok.svg`;
    if (name.includes("deepseek") || name.includes("deepseek")) return `${iconsBaseUrl}deepseek.svg`;
    if (name.includes("glm") || name.includes("glm")) return `${iconsBaseUrl}glm.svg`;
    return "";
}
